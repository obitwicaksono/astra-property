...
class HomePage extends StatelessWidget {
  ...
  List<ListPropertyModel> listProperty = ListPropertyModel.getListProperty();
        ...
        child: Center(
          child: Column(
            children: [
              ...
              SizedBox(height: 10),
              Text('List Top Rated Property', style: TextStyle(fontSize: 14)),
              SizedBox(height: 30),
              Expanded(
                child: ListView.builder(
                  itemCount: listProperty.length,
                  itemBuilder: (context, index) {
                    return ListProp(list: listProperty[index]);
                  },
                ),
              ),
            ],
